...
VALUE rb_define_class_id _((RB_ID, VALUE));
VALUE rb_module_new _((void));
VALUE rb_define_module_id _((RB_ID));
...
void rb_define_method_id _((VALUE, RB_ID, VALUE (*)(ANYARGS), int));
void rb_frozen_class_p _((VALUE));
void rb_undef _((VALUE, RB_ID));
...
NORETURN(void rb_name_error __((RB_ID, const char*, ...)));
...
void rb_alias _((VALUE, RB_ID, RB_ID));
void rb_attr _((VALUE,RB_ID,int,int,int));
int rb_method_boundp _((VALUE, RB_ID, int));
VALUE rb_dvar_defined _((RB_ID));
VALUE rb_dvar_curr _((RB_ID));
VALUE rb_dvar_ref _((RB_ID));
void rb_dvar_asgn _((RB_ID, VALUE));
void rb_dvar_push _((RB_ID, VALUE));
VALUE *rb_svar _((int));
VALUE rb_eval_cmd _((VALUE, VALUE, int));
int rb_respond_to _((VALUE, RB_ID));
void rb_interrupt _((void));
VALUE rb_apply _((VALUE, RB_ID, VALUE));
void rb_backtrace _((void));
RB_ID rb_frame_last_func _((void));
...
VALUE rb_thread_local_aref _((VALUE, RB_ID));
VALUE rb_thread_local_aset _((VALUE, RB_ID, VALUE));
void rb_thread_atfork _((void));
VALUE rb_funcall_rescue __((VALUE, RB_ID, int, ...));
/* file.c */
...
RB_ID rb_id_attrset _((RB_ID));
void rb_parser_append_print _((void));
void rb_parser_while_loop _((int, int));
int ruby_parser_stack_on_heap _((void));
void rb_gc_mark_parser _((void));
int rb_is_const_id _((RB_ID));
int rb_is_instance_id _((RB_ID));
int rb_is_class_id _((RB_ID));
int rb_is_local_id _((RB_ID));
int rb_is_junk_id _((RB_ID));
...
void rb_str_setter _((VALUE, RB_ID, VALUE*));
...
VALUE rb_struct_getmember _((VALUE, RB_ID));
...
void rb_name_class _((VALUE, RB_ID));
VALUE rb_class_name _((VALUE));
void rb_autoload _((VALUE, RB_ID, const char*));
void rb_autoload_load _((VALUE, RB_ID));
VALUE rb_autoload_p _((VALUE, RB_ID));
...
void rb_alias_variable _((RB_ID, RB_ID));
...
VALUE rb_ivar_get _((VALUE, RB_ID));
VALUE rb_ivar_set _((VALUE, RB_ID, VALUE));
VALUE rb_ivar_defined _((VALUE, RB_ID));
VALUE rb_iv_set _((VALUE, const char*, VALUE));
VALUE rb_iv_get _((VALUE, const char*));
VALUE rb_attr_get _((VALUE, RB_ID));
...
int rb_const_defined _((VALUE, RB_ID));
int rb_const_defined_at _((VALUE, RB_ID));
int rb_const_defined_from _((VALUE, RB_ID));
VALUE rb_const_get _((VALUE, RB_ID));
VALUE rb_const_get_at _((VALUE, RB_ID));
VALUE rb_const_get_from _((VALUE, RB_ID));
void rb_const_set _((VALUE, RB_ID, VALUE));
VALUE rb_mod_constants _((VALUE));
VALUE rb_mod_const_missing _((VALUE,VALUE));
VALUE rb_cvar_defined _((VALUE, RB_ID));
#define RB_CVAR_SET_4ARGS 1
void rb_cvar_set _((VALUE, RB_ID, VALUE, int));
VALUE rb_cvar_get _((VALUE, RB_ID));
