...
int rb_autoload_defined _((RB_ID));
...
void rb_const_assign _((VALUE, RB_ID, VALUE));
VALUE rb_mod_constants _((VALUE));
void rb_autoload_load _((RB_ID));
void rb_cvar_declare _((VALUE, RB_ID, VALUE));
VALUE rb_cvar_defined _((VALUE, RB_ID));
void rb_cvar_set _((VALUE, RB_ID, VALUE));
