...
{
  return ocobj_new_with_ocid(NSTextDidBeginEditingNotification);
}
...
{
  return ocobj_new_with_ocid(NSTextDidEndEditingNotification);
}
...
{
  return ocobj_new_with_ocid(NSTextDidChangeNotification);
}
