...
class ___VARIABLE_classPrefix:identifier___AppDelegate < OSX::NSObject
	...
	# file. This code uses a directory named "___VARIABLE_bundleIdentifierPrefix:bundleIdentifier___.___PACKAGENAMEASIDENTIFIER___"
	...
	def applicationFilesDirectory
		...
		return appsupportURL.URLByAppendingPathComponent_("___VARIABLE_bundleIdentifierPrefix:bundleIdentifier___.___PACKAGENAMEASIDENTIFIER___")
	end
